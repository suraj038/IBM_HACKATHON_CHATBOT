      ...
      <div class="container-fluid">
         <div class="row">
           <div class="page-header text-center">
             <h2>Banking Chatbot using IBM Watson Assistant</small></h2>
           </div>
           <div class="col-md-6 col-md-offset-3">
             <div class="thumbnail text-center">
               <img src="<?php echo base_url('assets/images/ebschatbot.png');?>" alt="" class="img-responsive" style="height: 100px;">
               <div class="caption">
                 <h3>Bank & Finance Bot</h3>
                 <p>This chatbot is a demo of IBM Watson Assistant tool on building a chatbot.</p>
                 <p><a href="<?php echo base_url('app/ajax/conversation_start.php');?>" class="btn btn-danger" role="button">Lets Chat</a></p>
               </div>
             </div>
           </div>
         </div>
         <div class="well well-sm text-center">Created by </div>
      </div>
<?php
